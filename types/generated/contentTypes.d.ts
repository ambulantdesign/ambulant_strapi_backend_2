...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    MarginalColumn: Attribute.DynamicZone<
      [
        'layout.rich-text',
        'media.single-image',
        'media.streaming-video',
        'media.video',
        'link-component.weblink'
      ]
    >;
    publishedAt: Attribute.DateTime;
    seo: Attribute.Component<'seo.seo-basic-fields'>;
    slug: Attribute.UID<'api::about.about', 'title'> & Attribute.Required;
...
export interface ApiArtistArtist extends Schema.CollectionType {
  ...
  attributes: {
    ...
    isInstitution: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    lastname: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::artist.artist', 'fullname'> & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::artist.artist',
      'oneToOne',
...
export interface ApiGalleryGallery extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sortName: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::gallery.gallery',
      'oneToOne',
...
export interface ApiImprintImprint extends Schema.SingleType {
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    seo: Attribute.Component<'seo.seo-basic-fields'>;
    slug: Attribute.UID<'api::imprint.imprint', 'title'> & Attribute.Required;
    title: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::imprint.imprint',
...
export interface ApiInstitutionInstitution extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::institution.institution', 'name'> &
      Attribute.Required;
    sortName: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
...
export interface ApiKeywordKeyword extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::keyword.keyword', 'name'> & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::keyword.keyword',
      'oneToOne',
...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    keywords: Attribute.Relation<
      ...
      'api::keyword.keyword'
    >;
    meta: Attribute.Component<'portfolio.work-additional-fields'>;
    productionDate: Attribute.Date & Attribute.Required;
    publishedAt: Attribute.DateTime;
    seo: Attribute.Component<'seo.seo-basic-fields'>;
    slug: Attribute.UID<'api::work.work', 'title'> & Attribute.Required;
    smallSlider: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    streamingVideo: Attribute.Component<'media.streaming-video'>;
    title: Attribute.String & Attribute.Required & Attribute.Unique;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<'api::work.work', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    Videos: Attribute.Component<'media.video', true>;
    Weblink: Attribute.Component<'link-component.weblink', true>;
  };
}
